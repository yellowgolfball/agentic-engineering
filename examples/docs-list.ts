 ...
 *
 * Walks the docs/ directory and lists all markdown files with their
 * summary and "read when" hints from YAML front matter.
 *
 * Usage: npx tsx scripts/docs-list.ts
 *    or: npm run docs:list  (if configured in package.json)
 *
 * Front matter format:
 *   ---
 *   summary: "Brief description of this doc"
 *   read_when:
 *     - keyword1
 *     - keyword2
 *   ---
...
if (markdownFiles.length === 0) {
  console.log('  (no docs found — add markdown files to docs/ with front matter)');
} else {
